...
router.get(
  '/',
  supplierContract.validateGetAllContracts,
  supplierContractController.getAllSupplierContracts,
);
router.post(
  '/',
  supplierContract.validateCreateContract,
  authenticate,
  supplierContractController.createSupplierContract,
);
