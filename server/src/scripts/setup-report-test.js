...
const setupReportTest = async () => {
  try {
    ...
    console.log('\n📋 Step 3: Summary');
    console.log('✅ Report test data setup completed successfully!');
    ...
    console.log('Representative: representative@example.com / password123');
    console.log('Warehouse Manager: warehouse_manager@example.com / password123');

    console.log('\n🎯 Test Data Features:');
    console.log('• Bills with different statuses (completed, pending, overdue)');
    console.log('• Bills across different months (Jan, Feb, Mar)');
    console.log('• Different bill types (IMPORT, EXPORT, PAYMENT_VOUCHER)');
    console.log('• Multiple contracts with different partner types');
    console.log('• Various medicines with different categories');
  } catch (error) {
    console.error('❌ Error setting up report test data:', error);
  } finally {
