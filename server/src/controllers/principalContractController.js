...
const updateAnnex = asyncHandler(async (req, res) => {
  ...
  const updatedContract = await principalContractService.updateAnnex(id, annex_code, annexData, req.user);
  res.status(200).json({ success: true, data: updatedContract });
});
...
const updateAnnexStatus = asyncHandler(async (req, res) => {
  ...
  const updatedContract = await principalContractService.updateAnnexStatus(id, annex_code, status, req.user);
  res.status(200).json({ success: true, data: updatedContract });
});
