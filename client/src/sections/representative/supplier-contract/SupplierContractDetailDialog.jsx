      ...
      <DialogContent sx={{ p: 3 }}>
        ...
        <Card sx={{ mb: 3, border: '1px solid #e0e0e0' }}>
          <CardContent>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} md={6}>
                <InfoField label="Ngày bắt đầu" value={format(new Date(contract.start_date), 'dd/MM/yyyy')} icon={EventIcon} />
              </Grid>
              <Grid item xs={12} md={6}>
                <InfoField label="Ngày kết thúc" value={format(new Date(contract.end_date), 'dd/MM/yyyy')} icon={EventIcon} />
              </Grid>
            </Grid>
          </CardContent>
        </Card>
