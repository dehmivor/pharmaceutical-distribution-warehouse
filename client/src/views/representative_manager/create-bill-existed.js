    ...
    <div style={{ padding: 20, border: '1px solid #ccc', borderRadius: 8, maxWidth: 500, margin: '20px auto', backgroundColor: '#fafafa' }}>
      ...
      <form onSubmit={handleSubmit}>
        <div style={{ marginBottom: 12 }}>
          <label>{billType === 'chi' ? 'Nhà cung cấp' : 'Khách hàng'}:</label>
          <br />
          <input
            type="text"
        ...
        <div style={{ marginBottom: 12 }}>
          ...
          <br />
          <input type="text" name="item" value={formData.item} onChange={handleChange} required style={{ width: '100%', padding: 6 }} />
        </div>
